...
def find_most_common_cooccurring_hashtag(tweet_data, hashtag_to_ignore):
    ...
    if high[0][0] is "#2020election":
        hashtag_list.append(high[1][0])
    else: 
        hashtag_list.append(high[0][0])
    
    str1 = ", " 
       
    return (str1.join(hashtag_list))
...
if __name__ == "__main__":
    ...
    print("The top 1 most commonly cooccurring hashtag with {} is {}.".format(hashtag, most_common_cooccurring_hashtag))
